...
def get_model_and_user_items_from_utility_matrix(utility_mat, calculate_training_loss = True, iterations=100, factors=50, regularization = 0.1):
    ...
    sparse_util = sparse.csr_matrix(utility_mat)

    model = implicit.als.AlternatingLeastSquares(factors = factors, calculate_training_loss = calculate_training_loss,iterations = iterations, regularization=regularization)
